...
All images in this article are built from Neo4j Bloom vizualisation tool: `https://neo4j.com/bloom/` 
The Norconex configuration is based on Neo4j Committer v2: `http://www.norconex.com/collectors/committer-neo4j/`
