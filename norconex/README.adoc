...
To handle that and having a continuous linkage between these pages, I need to link them. The property `redirect-trail` on the targetted page meta-data (injected by Norconex) allows to do that:
