...
Now I want to import California regions and their sub-regions. In the `https://discovercaliforniawines.com/discover-california/` page of this Web site, thre's a sub-banner with links to all the regions. And on each page of these regions, there are the links to sub-regions. Nice.
...
So, it is necessary to only extract the links from the sub-banner, doing that will reduce the treatment time .
